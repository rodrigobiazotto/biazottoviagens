...
function currentRoute(pathname = location.pathname){const p=pathname.replace(/\/+$/,'')||'/';return p==='/'?'home':p==='/sobre'?'sobre':p==='/servicos'?'servicos':p==='/como-funciona'?'processo':p==='/privacidade'?'privacidade':p==='/termos'?'termos':'notFound'}
